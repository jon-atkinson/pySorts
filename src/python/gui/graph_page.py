...
class GraphPage(tk.Frame):
    ...
    def resetFilters(self):
        self.plot(self.originalResults, self.n_steps, self.alg_names, self.num_reps, self.last_title)
